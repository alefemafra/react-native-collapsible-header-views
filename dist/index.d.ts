...
export type InterpolatedHeaderTranslation = (
  from: number,
  to: number
...
declare class CollapsibleHeaderView<
  T extends ScrollViewProps
> extends React.Component<CollapsibleHeaderViewProps<T>> {
...
export declare class CollapsibleHeaderFlatList<I> extends CollapsibleHeaderView<
  FlatListProps<I>
> {}
export declare class CollapsibleHeaderSectionList<
  I
> extends CollapsibleHeaderView<SectionListProps<I>> {}
